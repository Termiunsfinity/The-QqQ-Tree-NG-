...
function getPointGen() {
	...
	if (hasUpgrade('L', 12)) gain = Decimal.tetrate(gain.pow(2.25),1.05,1)
	if (hasUpgrade('L', 13)) gain = Decimal.tetrate(gain.pow(2.25),1.01,1)
	if (hasUpgrade('L', 22)) gain = Decimal.tetrate(gain.pow(2.25),Math.sqrt(gain.layer+10),1)
	if (hasUpgrade('L', 21)) gain = Decimal.tetrate(gain.pow(2.25),Math.sqrt(gain.layer+10)/10,1)
	if (gain.gte("(e^308)179")) gain = Decimal.tetrate(gain,0.9)
	return gain
}
